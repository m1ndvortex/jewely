...
class JewelryShopUser(HttpUser):
    ...
    def view_inventory_list(self):
        ...
        with self.client.get(f"/inventory/?page={page}", catch_response=True, name="/inventory/") as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def search_inventory(self):
        ...
        with self.client.get(f"/inventory/search/?q={term}", catch_response=True, name="/inventory/search/") as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def view_inventory_detail(self):
        ...
        with self.client.get(f"/inventory/{item_id}/", catch_response=True, name="/inventory/[id]/") as response:
    ...
    def create_inventory_item(self):
        ...
        with self.client.post("/inventory/create/", data=data, catch_response=True, name="/inventory/create/") as response:
    ...
    def process_sale(self):
        ...
        with self.client.post("/pos/sale/", json=data, catch_response=True, name="/pos/sale/") as response:
            if response.status_code in [200, 201, 302]:
                response.success()
            else:
    ...
    def view_customers(self):
        ...
        with self.client.get(f"/customers/?page={page}", catch_response=True, name="/customers/") as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def view_customer_detail(self):
        ...
        with self.client.get(f"/customers/{customer_id}/", catch_response=True, name="/customers/[id]/") as response:
    ...
    def view_sales_report(self):
        ...
        with self.client.get(f"/reports/sales/{report_type}/", catch_response=True, name="/reports/sales/") as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def view_inventory_report(self):
        ...
        with self.client.get(f"/reports/inventory/{report_type}/", catch_response=True, name="/reports/inventory/") as response:
            if response.status_code == 200:
                response.success()
            else:
...
class AdminUser(HttpUser):
    ...
    def view_admin_dashboard(self):
        ...
        with self.client.get("/admin/dashboard/", catch_response=True, name="/admin/dashboard/") as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def view_tenants(self):
        """View tenant list."""
        with self.client.get("/admin/tenants/", catch_response=True, name="/admin/tenants/") as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def view_system_metrics(self):
        """View system metrics."""
        with self.client.get("/admin/metrics/", catch_response=True, name="/admin/metrics/") as response:
            if response.status_code == 200:
                response.success()
            else:
