...
class SubscriptionEnforcementService:
    ...
    def _get_usage_and_limit(self, limit_type: LimitType) -> Tuple[int, int]:
        ...
        limit_mapping = {
            ...
            # Sales & POS Limits
            LimitType.POS_TERMINALS: (
                stats.pos_terminals,
                self.subscription.get_pos_terminals_limit(),
            ),
            LimitType.SALES_PER_MONTH: (
                stats.sales_this_month,
                self.subscription.get_sales_per_month_limit(),
            ),
            ...
            LimitType.TRANSACTIONS: (
                ...
                self.subscription.get_transactions_limit(),
            ),
            LimitType.CUSTOM_ORDERS: (
                stats.custom_orders_this_month,
                self.subscription.get_custom_orders_limit(),
            ),
            LimitType.REPAIR_ORDERS: (
                stats.repair_orders_this_month,
                self.subscription.get_repair_orders_limit(),
            ),
            LimitType.PURCHASE_ORDERS: (
                stats.purchase_orders_this_month,
                self.subscription.get_purchase_orders_limit(),
            ),
            # Marketing & Communication Limits
            LimitType.EMAIL_CAMPAIGNS: (
                stats.email_campaigns_this_month,
                self.subscription.get_email_campaigns_limit(),
            ),
            LimitType.SMS_CAMPAIGNS: (
                stats.sms_campaigns_this_month,
                self.subscription.get_sms_campaigns_limit(),
            ),
            LimitType.EMAILS_PER_MONTH: (
                stats.emails_sent_this_month,
                self.subscription.get_emails_per_month_limit(),
            ),
            LimitType.SMS_PER_MONTH: (
                stats.sms_sent_this_month,
                self.subscription.get_sms_per_month_limit(),
            ),
            # Advanced Features Limits
            LimitType.API_CALLS: (
                stats.api_calls_this_month,
                self.subscription.get_api_calls_per_month(),
            ),
            LimitType.REPORTS_PER_MONTH: (
                stats.reports_this_month,
                self.subscription.get_reports_per_month_limit(),
            ),
            LimitType.PRICING_RULES: (
                stats.pricing_rules,
                self.subscription.get_pricing_rules_limit(),
            ),
            LimitType.JOURNAL_ENTRIES: (
                stats.journal_entries_this_month,
                self.subscription.get_journal_entries_limit(),
            ),
            LimitType.LOYALTY_TIERS: (
                stats.loyalty_tiers,
                self.subscription.get_loyalty_tiers_limit(),
            ),
            # System Limits
            LimitType.STORAGE: (
            ...
            LimitType.BACKUP_RETENTION: (
                stats.backup_retention_days,
                self.subscription.get_backup_retention_days(),
            ),
            LimitType.CONCURRENT_SESSIONS: (
                stats.concurrent_sessions,
                self.subscription.get_concurrent_sessions_limit(),
            ),
    ...
    def _get_limit_exceeded_message(self, limit_type: LimitType, current: int, limit: int) -> str:
        ...
        messages = {
            # Core Business
            LimitType.USERS: _(
                "User limit reached ({current}/{limit}). Please upgrade your plan to add more users."
            ),
            LimitType.BRANCHES: _(
                "Branch limit reached ({current}/{limit}). Please upgrade your plan to add more branches."
            ),
            LimitType.INVENTORY: _(
                "Inventory limit reached ({current}/{limit}). Please upgrade your plan to add more items."
            ),
            LimitType.CONTACTS: _(
                "Contact limit reached ({current}/{limit}). Please upgrade your plan to add more contacts."
            ),
            LimitType.PRODUCTS: _(
                "Product limit reached ({current}/{limit}). Please upgrade your plan to add more products."
            ),
            LimitType.SUPPLIERS: _(
                "Supplier limit reached ({current}/{limit}). Please upgrade your plan to add more suppliers."
            ),
            LimitType.CATEGORIES: _(
                "Category limit reached ({current}/{limit}). Please upgrade your plan to add more categories."
            ),
            # Sales & POS
            LimitType.POS_TERMINALS: _(
                "POS terminal limit reached ({current}/{limit}). Please upgrade your plan to add more terminals."
            ),
            LimitType.SALES_PER_MONTH: _(
                "Monthly sales limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.GIFT_CARDS: _(
                "Gift card limit reached ({current}/{limit}). Please upgrade your plan to create more gift cards."
            ),
            # Monthly Operations
            LimitType.INVOICES: _(
                "Monthly invoice limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.TRANSACTIONS: _(
                "Monthly transaction limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.CUSTOM_ORDERS: _(
                "Monthly custom order limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.REPAIR_ORDERS: _(
                "Monthly repair order limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.PURCHASE_ORDERS: _(
                "Monthly purchase order limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            # Marketing & Communication
            LimitType.EMAIL_CAMPAIGNS: _(
                "Monthly email campaign limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.SMS_CAMPAIGNS: _(
                "Monthly SMS campaign limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.EMAILS_PER_MONTH: _(
                "Monthly email limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.SMS_PER_MONTH: _(
                "Monthly SMS limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            # Advanced Features
            LimitType.API_CALLS: _(
                "API call limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.REPORTS_PER_MONTH: _(
                "Monthly report limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.PRICING_RULES: _(
                "Pricing rule limit reached ({current}/{limit}). Please upgrade your plan to add more rules."
            ),
            LimitType.JOURNAL_ENTRIES: _(
                "Monthly journal entry limit reached ({current}/{limit}). Please upgrade your plan or wait for the next billing cycle."
            ),
            LimitType.LOYALTY_TIERS: _(
                "Loyalty tier limit reached ({current}/{limit}). Please upgrade your plan to add more tiers."
            ),
            # System
            LimitType.STORAGE: _(
                "Storage limit reached ({current}GB/{limit}GB). Please upgrade your plan for more storage."
            ),
            LimitType.BACKUP_RETENTION: _(
                "Backup retention limit reached. Please upgrade your plan for longer retention."
            ),
            LimitType.CONCURRENT_SESSIONS: _(
                "Concurrent session limit reached ({current}/{limit}). Please upgrade your plan for more sessions."
            ),
            LimitType.DOCUMENTS: _(
                "Document limit reached ({current}/{limit}). Please upgrade your plan to upload more documents."
            ),
            LimitType.WEBHOOKS: _(
                "Webhook limit reached ({current}/{limit}). Please upgrade your plan to add more webhooks."
            ),
        }

        message = messages.get(
            limit_type, _("Resource limit reached ({current}/{limit}). Please upgrade your plan.")
        )
    ...
    def _get_warning_message(self, limit_type: LimitType, current: int, limit: int) -> str:
        ...
        return str(
            _("You're using {percent}% of your {resource} limit. {remaining} remaining.")
        ).format(
    ...
    def get_subscription_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "trial_ends": (
                self.subscription.trial_end.isoformat() if self.subscription.trial_end else None
            ),
            "next_billing": (
                self.subscription.next_billing_date.isoformat()
                if self.subscription.next_billing_date
                else None
            ),
            "usage": stats.to_dict(),
    ...
    def reset_monthly_usage_for_all(cls):
        ...
        for subscription in subscriptions:
            if subscription.usage_reset_date:
                ...
                if (
                    subscription.usage_reset_date.month != now.month
                    or subscription.usage_reset_date.year != now.year
                ):
...
class FeatureNotEnabled(Exception):
    ...
    def __init__(self, feature_name: str, message: str = None):
        ...
        self.message = (
            message or f"Feature '{feature_name}' is not enabled for your subscription plan."
        )
...
def check_subscription_limit(
    tenant: "Tenant", limit_type: LimitType, increment: int = 1
) -> LimitCheckResult:
    """
