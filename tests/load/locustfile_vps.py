...
class APIUser(HttpUser):
    ...
    def on_start(self):
        ...
        response = self.client.post(
            "/api/token/", json={"username": "admin", "password": "admin123"}, name="API Token"
        )
    ...
    def api_customers(self):
        ...
        self.client.get("/api/crm/customers/", headers=self.headers, name="API Customers")

    @task(6)
    def api_sales(self):
        """List sales via API"""
        self.client.get("/api/sales/", headers=self.headers, name="API Sales")
