...
class JobStatistics(models.Model):
    ...
    # Resource usage (would be populated by monitoring system)
    avg_cpu_percent = models.FloatField(null=True, blank=True)
    avg_memory_mb = models.FloatField(null=True, blank=True)
