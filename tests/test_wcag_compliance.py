...
class TestLightThemeCompliance:
    ...
    def test_light_theme_primary_text(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Light theme primary text failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_light_theme_secondary_text(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Light theme secondary text failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_light_theme_primary_button(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Light theme primary button failed: {result.contrast_ratio:.2f}:1"
...
class TestDarkThemeCompliance:
    ...
    def test_dark_theme_primary_text(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Dark theme primary text failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_dark_theme_secondary_text(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Dark theme secondary text failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_dark_theme_primary_button(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Dark theme primary button failed: {result.contrast_ratio:.2f}:1"
...
class TestAllColorPairs:
    ...
    def test_all_color_pairs_pass_wcag(self):
        ...
        if failing:
            ...
            pytest.fail(
                f"{len(failing)} color pairs failed WCAG compliance:\n{failure_details}"
            )
...
class TestStatusColors:
    ...
    def test_light_theme_success_colors(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Light theme success colors failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_light_theme_warning_colors(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Light theme warning colors failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_light_theme_danger_colors(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Light theme danger colors failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_dark_theme_success_colors(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Dark theme success colors failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_dark_theme_warning_colors(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Dark theme warning colors failed: {result.contrast_ratio:.2f}:1"
    ...
    def test_dark_theme_danger_colors(self):
        ...
        result = verify_contrast(pair)
        assert result.passes is True, f"Dark theme danger colors failed: {result.contrast_ratio:.2f}:1"
