...
class TestTenantUserPasswordReset:
    ...
    def test_password_reset_requires_platform_admin(self, client, tenant, tenant_owner, tenant_employee):
    ...
    def test_password_reset_successful(self, client, platform_admin, tenant, tenant_owner):
        ...
        assert "Password reset initiated" in response.content.decode()
    ...
    def test_password_reset_prevents_platform_admin_reset(self, client, platform_admin, tenant):
        ...
        assert response.status_code == 200
        assert "Cannot reset password for platform administrators" in response.content.decode()
...
class TestTenantUserRoleChange:
    ...
    def test_role_change_requires_platform_admin(self, client, tenant, tenant_owner, tenant_employee):
    ...
    def test_role_change_successful(self, client, platform_admin, tenant, tenant_employee):
        ...
        assert "changed from" in response.content.decode()

        # Verify role was actually changed
        tenant_employee.refresh_from_db()
        assert tenant_employee.role == User.TENANT_MANAGER

    def test_role_change_prevents_platform_admin_role(self, client, platform_admin, tenant, tenant_employee):
...
class TestTenantUserToggleActive:
    ...
    def test_toggle_active_requires_platform_admin(self, client, tenant, tenant_owner, tenant_employee):
    ...
    def test_toggle_active_prevents_platform_admin_deactivation(self, client, platform_admin, tenant):
...
class TestTenantDetailUsersTab:
    ...
    def test_users_tab_displays_all_tenant_users(self, client, platform_admin, tenant, tenant_owner, tenant_employee):
    ...
    def test_users_tab_shows_user_roles(self, client, platform_admin, tenant, tenant_owner, tenant_employee):
